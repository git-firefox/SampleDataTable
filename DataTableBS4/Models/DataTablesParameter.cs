...
namespace DataTableBS4.Models
{
    ...
    /// </summary>
    /// <param name="Column"> Column to which ordering should be applied.
    /// This is an index reference to the columns array of information that is also submitted to the server. </param>
    /// <param name="Dir"> Ordering direction for this column.
    /// It will be dt-string asc or dt-string desc to indicate ascending ordering or descending ordering, respectively. </param>
    public record DataTableOrder(int Column, DataTableOrderDir Dir);
